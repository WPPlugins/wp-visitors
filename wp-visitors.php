...
/*  
  ...
  Description: This plugin will keep track of visitors' information. Check <a href="index.php?page=wp-visitors/wp-visitors.php">this page</a> for details. Requires at least 2.6.3 and tested upto 2.7.1
  Author: Gowtham
...
function record_wpvisitors() {
  ...
  $gi = geoip_open(ABSPATH."wp-content/plugins/wp-visitors/geo_ip/GeoLiteCity.dat",GEOIP_STANDARD);
